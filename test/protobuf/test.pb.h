...
class ResultCode :
 ...
 public:
  ...
  // bytes errnum = 1;
  void clear_errnum();
  const std::string& errnum() const;
  void set_errnum(const std::string& value);
  void set_errnum(std::string&& value);
  void set_errnum(const char* value);
  void set_errnum(const void* value, size_t size);
  std::string* mutable_errnum();
  std::string* release_errnum();
  void set_allocated_errnum(std::string* errnum);
  private:
  const std::string& _internal_errnum() const;
  void _internal_set_errnum(const std::string& value);
  std::string* _internal_mutable_errnum();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr errnum_;
...
class LoginRequest :
 ...
 public:
  ...
  // .fixbug.ResultCode rs = 3;
  bool has_rs() const;
  private:
  bool _internal_has_rs() const;
  public:
  void clear_rs();
  const ::fixbug::ResultCode& rs() const;
  ::fixbug::ResultCode* release_rs();
  ::fixbug::ResultCode* mutable_rs();
  void set_allocated_rs(::fixbug::ResultCode* rs);
  private:
  const ::fixbug::ResultCode& _internal_rs() const;
  ::fixbug::ResultCode* _internal_mutable_rs();
  public:
...
inline void ResultCode::clear_errnum() {
  errnum_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResultCode::errnum() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errnum)
  return _internal_errnum();
}
inline void ResultCode::set_errnum(const std::string& value) {
  _internal_set_errnum(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errnum)
}
inline std::string* ResultCode::mutable_errnum() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.errnum)
  return _internal_mutable_errnum();
}
inline const std::string& ResultCode::_internal_errnum() const {
  return errnum_.GetNoArena();
}
inline void ResultCode::_internal_set_errnum(const std::string& value) {
  
  errnum_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResultCode::set_errnum(std::string&& value) {
  
  errnum_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.ResultCode.errnum)
}
inline void ResultCode::set_errnum(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errnum_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.ResultCode.errnum)
}
inline void ResultCode::set_errnum(const void* value, size_t size) {
  
  errnum_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.ResultCode.errnum)
}
inline std::string* ResultCode::_internal_mutable_errnum() {
  
  return errnum_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResultCode::release_errnum() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.errnum)
  
  return errnum_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResultCode::set_allocated_errnum(std::string* errnum) {
  if (errnum != nullptr) {
    
  } else {
    
  }
  errnum_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), errnum);
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.errnum)
}
...
// .fixbug.ResultCode rs = 3;
inline bool LoginRequest::_internal_has_rs() const {
  return this != internal_default_instance() && rs_ != nullptr;
}
inline bool LoginRequest::has_rs() const {
  return _internal_has_rs();
}
inline void LoginRequest::clear_rs() {
  if (GetArenaNoVirtual() == nullptr && rs_ != nullptr) {
    delete rs_;
  }
  rs_ = nullptr;
}
inline const ::fixbug::ResultCode& LoginRequest::_internal_rs() const {
  const ::fixbug::ResultCode* p = rs_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& LoginRequest::rs() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.rs)
  return _internal_rs();
}
inline ::fixbug::ResultCode* LoginRequest::release_rs() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRequest.rs)
  
  ::fixbug::ResultCode* temp = rs_;
  rs_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginRequest::_internal_mutable_rs() {
...
inline ::fixbug::ResultCode* LoginRequest::mutable_rs() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRequest.rs)
  return _internal_mutable_rs();
}
inline void LoginRequest::set_allocated_rs(::fixbug::ResultCode* rs) {
  ...
  rs_ = rs;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRequest.rs)
}
...
// .fixbug.ResultCode rs = 1;
inline bool LoginResponse::_internal_has_rs() const {
  return this != internal_default_instance() && rs_ != nullptr;
}
inline bool LoginResponse::has_rs() const {
  return _internal_has_rs();
}
inline void LoginResponse::clear_rs() {
  if (GetArenaNoVirtual() == nullptr && rs_ != nullptr) {
    delete rs_;
  }
  rs_ = nullptr;
}
inline const ::fixbug::ResultCode& LoginResponse::_internal_rs() const {
  const ::fixbug::ResultCode* p = rs_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& LoginResponse::rs() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.rs)
  return _internal_rs();
}
inline ::fixbug::ResultCode* LoginResponse::release_rs() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.rs)
  
  ::fixbug::ResultCode* temp = rs_;
  rs_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginResponse::_internal_mutable_rs() {
...
inline ::fixbug::ResultCode* LoginResponse::mutable_rs() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.rs)
  return _internal_mutable_rs();
}
inline void LoginResponse::set_allocated_rs(::fixbug::ResultCode* rs) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rs_;
  }
  ...
  rs_ = rs;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.rs)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequest::uid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequest.uid)
  return _internal_uid();
}
inline void GetFriendListRequest::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  uid_ = value;
}
inline void GetFriendListRequest::set_uid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequest.uid)
}

// bool success = 2;
inline void GetFriendListRequest::clear_success() {
  success_ = false;
}
inline bool GetFriendListRequest::_internal_success() const {
  return success_;
}
inline bool GetFriendListRequest::success() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequest.success)
  return _internal_success();
}
inline void GetFriendListRequest::_internal_set_success(bool value) {
  
  success_ = value;
}
inline void GetFriendListRequest::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequest.success)
}
...
// .fixbug.ResultCode rs = 1;
inline bool GetFriendListsResponse::_internal_has_rs() const {
  return this != internal_default_instance() && rs_ != nullptr;
}
inline bool GetFriendListsResponse::has_rs() const {
  return _internal_has_rs();
}
inline void GetFriendListsResponse::clear_rs() {
  if (GetArenaNoVirtual() == nullptr && rs_ != nullptr) {
    delete rs_;
  }
  rs_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsResponse::_internal_rs() const {
  const ::fixbug::ResultCode* p = rs_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsResponse::rs() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.rs)
  return _internal_rs();
}
inline ::fixbug::ResultCode* GetFriendListsResponse::release_rs() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResponse.rs)
  
  ::fixbug::ResultCode* temp = rs_;
  rs_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResponse::_internal_mutable_rs() {
...
inline ::fixbug::ResultCode* GetFriendListsResponse::mutable_rs() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.rs)
  return _internal_mutable_rs();
}
inline void GetFriendListsResponse::set_allocated_rs(::fixbug::ResultCode* rs) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rs_;
  }
  ...
  rs_ = rs;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResponse.rs)
}
